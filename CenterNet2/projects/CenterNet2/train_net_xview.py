    ...
    with EventStorage(start_iter) as storage:
        ...
        for data, iteration in zip(data_loader, range(start_iter, max_iter)):
            ...
            if iteration - start_iter > 5 and \
                (iteration % 500 == 0 or iteration == max_iter):
...
def setup(args):
    ...
    cfg.OUTPUT_DIR=cfg.OUTPUT_DIR+"/xView/Heat_DDA_50Epoch_512Batch"
...
def get_visdrone_dicts(img_dir, annotaion_dir):
    json_file = os.path.join(annotaion_dir, "xView_train_annotations.json")
...
def registrar_dataset():
    for d in ["train"]:
        DatasetCatalog.register("xview_" + d, lambda d=d: get_visdrone_dicts("/home/ubq3/bishalworkspace/Overhead_Imagery_survey/Datasets/xView/Full_Size/split_640/train/images", "/home/ubq3/bishalworkspace/Overhead_Imagery_survey/Datasets/xView/Full_Size/split_640/train"))
