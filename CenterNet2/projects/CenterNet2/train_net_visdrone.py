...
def setup(args):
    ...
    cfg.merge_from_file("/home/ubq3/CenterNet2/projects/CenterNet2/configs/CenterNet-FPN_R50_1x.yaml")
    ...
    cfg.SOLVER.MAX_ITER = 179600    # 300 iterations seems good enough for this toy dataset; you will need to train longer for a practical dataset
    ...
    cfg.OUTPUT_DIR=cfg.OUTPUT_DIR+"/visdrone19/features_faster_rcnn_R_50_FPN_1x(256 PPI_15Epoch)"
...
def get_visdrone_dicts(img_dir, annotaion_dir):
    json_file = os.path.join(annotaion_dir, "visdrone_annotations.json")
...
def registrar_dataset():
    for d in ["train"]:
        DatasetCatalog.register("visdrone_" + d, lambda d=d: get_visdrone_dicts("/home/bishal/bishal workspace/Overhead_Imagery_survey/Datasets/VisDrone2019/" + d +"/images", "/home/bishal/bishal workspace/Overhead_Imagery_survey/Datasets/VisDrone2019/"+ d))
