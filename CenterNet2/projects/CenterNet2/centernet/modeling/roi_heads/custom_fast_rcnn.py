...
class CustomFastRCNNOutputLayers(FastRCNNOutputLayers):
    ...
    def softmax_cross_entropy_loss(self, pred_class_logits, gt_classes, alpha):
        ...
        """
        # print(f"loss function: softmax_cross_entropy_loss")
    ...
    def predict_probs(self, predictions, proposals):
        ...
        return probs.split(num_inst_per_image, dim=0)
                ...
                # print(loss.grad_fn.next_functions[0][0].next_functions[0][0].next_functions[1][0]
                #         .next_functions)
                # print(loss.grad_fn.next_functions[0][0].next_functions[0][0].next_functions[1][0].
                #         next_functions[0][0].next_functions)
                # print(loss.grad_fn.next_functions[0][0].next_functions[0][0].next_functions[1][0].
                #         next_functions[0][0].next_functions[0][0].next_functions)
                # print(loss.grad_fn.next_functions[0][0].next_functions[0][0].next_functions[1][0].
                #         next_functions[0][0].next_functions[0][0].next_functions[0][0].next_functions)
                ...
                #         .next_functions[0][0].next_functions[0][0].next_functions[0][0].next_functions)
                # print(loss.grad_fn.next_functions[0][0].next_functions[0][0].next_functions[0][0]
                #         .next_functions[0][0].next_functions[0][0].next_functions[0][0].next_functions[0][0].next_functions)
                # print(loss.grad_fn.next_functions[0][0].next_functions[0][0].next_functions[0][0]
                #         .next_functions[0][0].next_functions[0][0].next_functions[0][0].next_functions[0][0].next_functions[0][0].next_functions)
                # print(loss.grad_fn.next_functions[0][0].next_functions[0][0].next_functions[0][0]
                #         .next_functions[0][0].next_functions[0][0].next_functions[0][0].
                #         next_functions[0][0].next_functions[0][0].next_functions[0][0].next_functions)
                # print(loss.grad_fn.next_functions[0][0].next_functions[0][0].next_functions[0][0]
                #         .next_functions[0][0].next_functions[0][0].next_functions[0][0].
                #         next_functions[0][0].next_functions[0][0].next_functions[0][0].next_functions[0][0].next_functions)