...
class CustomROIHeads(StandardROIHeads):
    ...
    def forward(self, images, features, proposals, name, iter_num, targets=None):
        """
        enable debug
        """
        ...
        if self.training:
            losses = self._forward_box(features, proposals, object_per_image, name, iter_num)
            losses.update(self._forward_mask(features, proposals))
            losses.update(self._forward_keypoint(features, proposals))
            return proposals, losses
        else:
            pred_instances = self._forward_box(features, proposals, object_per_image, name, iter_num)
