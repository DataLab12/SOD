...
def setup(args):
    ...
    #cfg.MODEL.WEIGHTS = "/home/ubq3/bishal workspace/Overhead_Imagery_survey/Expriments/Detectron2/dota/faster_rcnn_R_50_FPN_1x_30Epoch/model_final.pth" # Let training initialize from model zoo
    ...
    cfg.OUTPUT_DIR=cfg.OUTPUT_DIR+"/DOTA/debug"
...
def get_dota_dicts(img_dir, annotaion_dir):
    json_file = os.path.join(annotaion_dir, "dior_annotation_train.json")
...
def registrar_dataset():
    for d in ["train"]:
        DatasetCatalog.register("dota_" + d, lambda d=d: get_dota_dicts("/home/ubq3/bishalworkspace/Overhead_Imagery_survey/Datasets/DIOR/train/images", "/home/ubq3/bishalworkspace/Overhead_Imagery_survey/Datasets/DIOR/train"))
